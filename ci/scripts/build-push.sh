...
echo "cd src/github.com/JeffDeCola/catch-microservice"
...
cp "$GOPATH/src/github.com/JeffDeCola/catch-microservice/bin/catch" .
echo " "

echo "cp the Dockerfile into /dist"
cp "$GOPATH/src/github.com/JeffDeCola/catch-microservice/build-push/Dockerfile" .
echo " "
