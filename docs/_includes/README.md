...
A pipeline file [pipeline.yml](https://github.com/JeffDeCola/catch-microservice/tree/master/ci/pipeline.yml)
shows the entire ci flow. Visually, it looks like,

![IMAGE - catch-microservice concourse ci pipeline - IMAGE](pics/catch-microservice-pipeline.jpg)

The `jobs` and `tasks` are,

* `job-readme-github-pages` runs task
  [readme-github-pages.sh](https://github.com/JeffDeCola/catch-microservice/tree/master/ci/scripts/readme-github-pages.sh).
